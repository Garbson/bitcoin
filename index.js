fetch('https://api.coingecko.com/api/v3/simple/price?ids=bitcoin%2Ccardano%2Cethereum%2Ctether%2Clitecoin%2Cdogecoin&vs_currencies=usd&include_24hr_vol=true')
.then(res => res.json())
.then(json => {
